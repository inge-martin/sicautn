<section class="content">
	...
	<div class="col-md-6">
		<h1>Exito al guardar el Personal</h1>
  <div class="box box-primary">
	    ...
	    <li class="list-group-item">
		  ...
		  <a href="<?php echo base_url(); ?>Controller_administrador/administrativos" class="btn btn-primary btn-block">
		  	<b>Ver Listado de Personal</b>
		  </a>
			</div>
			<!-- /.box-body -->
		</div>
