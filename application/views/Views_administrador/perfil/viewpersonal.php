<?php
    ...
    require_once 'application/controllers/Controller_administrador/cPerfil/cPersonal.php';
    require_once 'application/models/modelosAdministrador/mPerfil/mPersonal.php';
    ...
    if(isset($_REQUEST['action'])){
        switch($_REQUEST['action']){
            case 'actualizar':
                ...
                redirect(base_url(). 'Controller_administrador/personales');
...
<section class="content">
    ...
    <?php 
        ...
        $url = $dominio.$dir;
        $actual = 'localhost/sicautn/Controller_administrador/personales';
        if($url == $actual){
            //ocultas
    ?>
