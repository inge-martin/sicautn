<?php
    ...
    require_once 'application/controllers/Controller_administrador/cAdministrativos.php';
    require_once 'application/models/modelosAdministrador/mAdministrativos.php';

    // Logica
    $alm = new cAdministrativos();
    $model = new  mAdministrativos();
?>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">Listado de Datos Personales de los Administrativos</h3>
                </div>
