<?php
    ...
    require_once 'application/controllers/Controller_administrador/cPersonal.php';
    require_once 'application/models/modelosAdministrador/mPersonal.php';
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">Listado de Datos Personales de los Alumnos</h3>
                </div>
