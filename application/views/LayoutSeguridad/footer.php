...
<?php
/*
por que la url normalmente es asi
http://localhost/proyecto/controlador/metodo
tons localhost es el servidor
proyecto es el segmento 0
controlador el segmento 1
y metodo el segmento 2
http://localhost/sicautn/Controller_seguridad/penalizaciones
*/
  if($this->uri->segment(2) == 'penalizaciones') { ?>
