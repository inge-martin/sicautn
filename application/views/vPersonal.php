...
<section class="content">
  <form class="form-horizontal" action="<?php echo base_url(); ?>cPersonal/guardar" method="POST" enctype="multipart/form-data" name="formulario">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <h4 class="attachment-block clearfix">
          Para continuar con tu registro, es necesario que ingreses tus datos principales para poder verificar tu autenticidad.
        </h4><br>
      ...
      <div class="box-body">
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select id="cboTipoUsuario" name="txtTipoUsuario" class="col-sm-8 form-control">
              </select>
            </div>          
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="input1" placeholder="CURP" name="txtCurp" required maxlength="18" minlength="18">
            </div> 
          </div>            
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select id="cboCarreras" name="txtCarrera" class="col-sm-8 form-control">
              </select>
            </div>
