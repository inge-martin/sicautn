...
class MProfesores{
	...
	public function Listar()
	{
		try
		{
			$result = array();
$sql  = " SELECT ";
$sql .= " personal.matricula, personal.turno, carreras.nombre nombreCarrera, personal.nombre nombrePersonal, personal.ap_paterno, ";
...
$sql .= " FROM personal, carreras, usuarios, direccion, estados, municipios, localidades";
...
$sql .= " AND personal.id_tipo_usuarios = 3";
			...
			foreach($stm->fetchAll(PDO::FETCH_OBJ) as $r)
			{
				...
				$alm->__SET('nombreCarrera', $r->nombreCarrera);
	...
	public function Actualizar(cProfesores $data)	{
		try 
		{
	...
	public function Registrar(cProfesores $data)	{
		try 
		{
